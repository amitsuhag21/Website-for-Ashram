...
$sql = "Select * from   tb_od_gurus where 1 order by guruid desc LIMIT $start_from, $limit ";
...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid text-right"><button class="btn btn-primary"
                onclick="document.location.href = 'guru_add_edit.php'"><a href="<?php echo 'guru_add_edit.php?action=add&v='.rand(1000000000,100000000000)?>"
                    style="color:#fff">Add Gurus</a></button></div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered data-table">
                            ...
                            <tr class="gradeX">
                                <td><?php echo $i ?></td>
                                <td><strong><?php echo $row['guruname']; ?></strong></td>
                                <td><strong><?php echo $row['language']; ?></strong></td>
                                <?php 
                                 $node_id = $row['guruid'];
                                        if ($row['status'] == 1) {
                                      echo       $output = '<td id="published' . $node_id . '"> <div class="onoffswitch">
        <input type="checkbox" autocomplete="off" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch' . $node_id . '" checked onclick="updateBudgetitemStatus(\'' . '' . 'function.php?&tbl=tb_od_gurus&id=' . $node_id . '\')">
        <label class="onoffswitch-label" for="myonoffswitch' . $node_id . '">
            ...
            <span class="onoffswitch-switch"></span>
                                      ...
                                      echo       $output = '<td id="published' . $node_id . '"> <div class="onoffswitch">
        <input type="checkbox" autocomplete="off" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch' . $node_id . '" onclick="updateBudgetitemStatus(\'' . '' . 'function.php?&tbl=tb_od_gurus&id=' . $node_id . '\')">
        <label class="onoffswitch-label" for="myonoffswitch' . $node_id . '">
            <span class="onoffswitch-inner"></span>
            <span class="onoffswitch-switch"></span>
        </label>
                                ...
                                <td class="center">
                                    <div class="btn-group"><button
                                            class="btn "><a href='<?php echo 'guru_add_edit.php?action=edit&id='.$node_id?>'> Edit <a> <span
                                                ></span></button>
                                            <li><a href='<?php echo 'guru_add_edit.php?action=edit&id='.$node_id?>'>Edit</a></li>
                                       </div>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        $sql1 = "SELECT COUNT(*) FROM tb_od_gurus";   
...
$num_results_on_page = 10;
      ?>
                        ...
                        <ul class="pagination">
                            <?php if ($page > 1): ?>
                            <li class="prev"><a href="guru_list.php?page=<?php echo $page-1 ?>">Prev</a></li>
                            <?php endif; ?>

                            <?php if ($page > 3): ?>
                            <li class="start"><a href="guru_list.php?page=1">1</a></li>
                            <li class="dots">...</li>
                            <?php endif; ?>

                            <?php if ($page-2 > 0): ?><li class="page"><a
                                    href="guru_list.php?page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li>
                            <?php endif; ?>
                            <?php if ($page-1 > 0): ?><li class="page"><a
                                    href="guru_list.php?page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li>
                            <?php endif; ?>

                            <li class="currentpage"><a
                                    href="guru_list.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>
                            ...
                            <li class="dots">...</li>
                            <li class="end"><a
                                    href="guru_list.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a>
                            </li>
                            <?php endif; ?>

                            <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                            <li class="next"><a href="guru_list.php?page=<?php echo $page+1 ?>">Next</a></li>
                            <?php endif; ?>
                        </ul>
                        <?php endif; ?>
